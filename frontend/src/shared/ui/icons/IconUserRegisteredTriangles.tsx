...
/** Triangle mosaic — first passport emblem form (`el-1` … `el-24`). */
const ICON_USER_REGISTERED_TRIANGLES_ELEMENTS: IconElement[] = [
  {
    id: '1',
  ...
  {
    // В исходном SVG — `el-127` (опечатка); в паспорте ключ `17`.
    id: '17',
    d: 'm2560 4020 640-365 640-365-1280-729z',
  },
  {
...
export type IconUserRegisteredTrianglesProps = Omit<
...
export const IconUserRegisteredTriangles = ({
  elementColors,
  outlineColor = 'currentColor',
  ...props
}: IconUserRegisteredTrianglesProps) => (
  <svg
  ...
  >
    <g>
      {ICON_USER_REGISTERED_TRIANGLES_ELEMENTS.map((element) => {
