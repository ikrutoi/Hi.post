...
import { useToolbarController } from '../application/Toolbar.controller'
import { getToolbarIcon } from 'shared-legacy/ui/getToolbarIcon'
import {
  handleMouseEnterBtn,
  handleMouseLeaveBtn,
...
export const Toolbar: React.FC = () => {
  const { handleClickBtn, handleMouseLeave, setBtnIconRef } =
    ...
    <div className={styles.toolbar}>
      {toolbarButtons.map((btn) => (
        <button
          ...
          className={`${styles.toolbar__btn} ${styles[`toolbar__btn--${btn}`]}`}
