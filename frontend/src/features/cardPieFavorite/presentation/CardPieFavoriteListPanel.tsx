...
import { CardPieFavorityListEntry } from './cardPieFavoriteList/CardPieFavorityListEntry'
import type { DateListPanelItem } from '@date/presentation/DateListPanel'
import {
  buildCardPieRefsKey,
  listCardPieFavorites,
  toggleCardPieFavoriteByRefs,
} from '@features/cardPie/application/services/cardPieFavoritesService'
import styles from './CardPieFavoriteListPanel.module.scss'
...
const CardPieFavoritePanelRow: React.FC<{
  ...
  return (
    <CardPieFavorityListEntry
      ...
      favoriteDisabled={!isFavorite && !canFavorite}
      onToggleFavorite={
...
export const CardPieFavoriteListPanel: React.FC<Props> = ({
  onClose,
  entries = [],
  onSelectEntry,
}) => {
