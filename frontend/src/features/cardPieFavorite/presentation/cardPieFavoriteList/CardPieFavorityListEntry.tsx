...
import styles from './CardPieFavorityListEntry.module.scss'

export type CardPieFavorityListEntryVariant = 'default' | 'inactive'

export type CardPieFavorityListEntryProps = {
  dateLabel: string
  previewUrl?: string | null
  detailLine?: string
  priceLine?: string
  variant?: CardPieFavorityListEntryVariant
  onSelect?: () => void
  isSelected?: boolean
  isFocused?: boolean
  onAddCart?: () => void
...
export const CardPieFavorityListEntry: React.FC<CardPieFavorityListEntryProps> = ({
  dateLabel,
  previewUrl,
  detailLine,
  priceLine,
