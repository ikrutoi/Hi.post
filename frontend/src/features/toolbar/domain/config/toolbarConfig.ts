...
export const TOOLBAR_CONFIG: ToolbarSectionConfigMap = {
  ...
  recipientCreate: {
    keys: VIEW_KEYS,
    initialState: initialRecipientCreateToolbarState,
    onAction: (key, section, _editor, dispatch) => {
      dispatch({ type: 'toolbar/action', payload: { section, key } })
    },
    group: 'recipientCreate',
    getBadges: (state: ToolbarState['recipientCreate']) => ({}),
    toolbar: RECIPIENT_CREATE_TOOLBAR,
  },
  ...
  rightSidebar: {
    keys: RIGHT_SIDEBAR_KEYS,
    initialState: initialRightSidebarToolbarState,
    onAction: (key, section, _editor, dispatch) => {
      dispatch({ type: 'toolbar/action', payload: { section, key } })
    },
    group: 'rightSidebar',
    getBadges: (state: ToolbarState['rightSidebar']) => ({}),
  ...
  cartList: {
    keys: CART_LIST_KEYS,
    initialState: initialCartListToolbarState,
    onAction: (key, section, _editor, dispatch) => {
      dispatch({ type: 'toolbar/action', payload: { section, key } })
    },
    group: 'cartList',
  ...
  postcardPieCart: {
    keys: POSTCARD_PIE_CART_KEYS,
    initialState: initialPostcardPieCartToolbarState,
    onAction: (key, section, _editor, dispatch) => {
      dispatch({ type: 'toolbar/action', payload: { section, key } })
    },
  ...
  userPanelChoicePhoto: {
    ...
    initialState: initialUserPanelChoicePhotoToolbarState,
    onAction: (key, section, _editor, dispatch) => {
      dispatch({ type: 'toolbar/action', payload: { section, key } })
    },
